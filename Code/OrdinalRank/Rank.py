...
datar = pd.read_csv("./Final_sRNARFTarget_Ecoli.txt", header=0, delimiter = "\t") 
datar.iloc[:,-2] # Scores
...
datac = pd.read_csv("./Final_CopraRNA_Ecoli.txt", header=0, delimiter = "\t") 
datac.iloc[:,-2] # Scores
...
datai = pd.read_csv("./Final_IntaRNA_Ecoli.txt", header=0, delimiter = "\t") 
datai.iloc[:,-2] # Scores
