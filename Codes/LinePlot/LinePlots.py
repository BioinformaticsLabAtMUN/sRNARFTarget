...
import pandas as pd
ecolirf = pd.read_csv('./Data/PlotsData/Line/Ecoli/sRNARFTarget_Ecoli.txt', header = 0,sep = '\t')
ecolirf.head()
...
import pandas as pd
ecolicopra = pd.read_csv('./Data/PlotsData/Line/Ecoli/CopraRNA_Ecoli.txt', header = 0,sep = '\t')
ecolicopra.head()
...
import pandas as pd
ecoliinta = pd.read_csv('./Data/PlotsData/Line/Ecoli/IntaRNA_Ecoli.txt', header = 0,sep = '\t')
ecoliinta.head()
...
import pandas as pd
pccrf = pd.read_csv('..=/Data/PlotsData/Line/PCC/sRNARFTarget_PCC.txt', header = 0,sep = '\t')
pccrf.head()
...
import pandas as pd
pcccopra = pd.read_csv('./Data/PlotsData/Line/PCC/CopraRNA_PCC.txt', header = 0,sep = '\t')
pcccopra.head()
...
import pandas as pd
pccinta = pd.read_csv('./Data/PlotsData/Line/PCC/IntaRNA_PCC.txt', header = 0,sep = '\t')
pccinta.head()
...
import pandas as pd
multorf = pd.read_csv('./Data/PlotsData/Line/Multocida/sRNARFTarget_Multocida.txt', header = 0,sep = '\t')
multorf.head()
...
import pandas as pd
multocopra = pd.read_csv('./Data/PlotsData/Line/Multocida/CopraRNA_Multocida.txt', header = 0,sep = '\t')
multocopra.head()
...
import pandas as pd
multointa = pd.read_csv('./Data/PlotsData/Line/Multocida/IntaRNA_Multocida.txt', header = 0,sep = '\t')
multointa.head()
