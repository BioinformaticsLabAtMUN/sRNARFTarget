...
Requirements for running sRNARFTarget:
  ...
  3. Python modules: pickle, Bio, pprint, [skbio](http://scikit-bio.org/), itertools, [sklearn](https://scikit-learn.org/stable/), [pandas](https://pandas.pydata.org/), [numpy](https://numpy.org/).
